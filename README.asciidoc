...
----
+
* 修改proguard文件，需要保持com.ksyun.media.streamer下的所有类：
+
----
...
[NOTE]
====
初次开启预览后需要在mOnStatusListener回调中收到
...
* https://github.com/ksvc/KSYStreamer_Android/wiki/Audio_Mixer[混音]
* https://github.com/ksvc/KSYStreamer_Android/wiki/Audio_Filter[音频滤镜]
